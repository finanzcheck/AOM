...
/**
 * Example:
 * ./console aom:import --platform=Bing --startDate=2017-02-26 --endDate=2017-02-26
 * ./console aom:import --platform=AdWords --startDate=2017-04-10 --endDate=2017-04-10 --merge=true
 */
