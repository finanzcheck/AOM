...
//        $this->assertEquals(
//            'AdWords',
//            Db::fetchOne('SELECT aom_platform FROM piwik_log_visit WHERE user_id = "c1aed2f5b1f79d27951b0b309ff42919"')
//        );
//
//        $this->assertEquals(
...
//        $this->assertEquals(
//            'Bing',
//            Db::fetchOne('SELECT aom_platform FROM piwik_log_visit WHERE user_id = "aed2f5b1f79d27951b0b309ff42919c1"')
//        );
//
//        $this->assertEquals(
...
//        $this->assertEquals(
//            'Criteo',
//            Db::fetchOne('SELECT aom_platform FROM piwik_log_visit WHERE user_id = "d2f5b1f79d27951b0b309ff42919c1ae"')
//        );
//
//        $this->assertEquals(
...
//        $this->assertEquals(
//            'FacebookAds',
//            Db::fetchOne('SELECT aom_platform FROM piwik_log_visit WHERE user_id = "f5b1f79d27951b0b309ff42919c1aed2"')
//        );
//
//        $this->assertEquals(
