...
class BingAdParamsTest extends IntegrationTestCase
{
    ...
    public function testOnNewVisitUrlWithAllRequiredParams()
    {
        $request = new Request([
            'idsite' => 1,
            'url' => 'finanzcheck.de/lp/sofortkredit/?aom_platform=Bing&aom_campaign_id=14630904343'
    ...
    public function testOnNewVisitUrlWithMissingParamCampaignId()
    {
        $request = new Request([
            'idsite' => 1,
            'url' => 'finanzcheck.de/lp/sofortkredit/?aom_platform=Bing&baseline=1463090434342747916'
