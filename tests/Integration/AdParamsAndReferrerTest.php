...
class AdParamsAndReferrerTest extends IntegrationTestCase
{
    ...
    public function testOnNewVisitUrl()
    {
        $request = new Request([
            'idsite' => 1,
            'url' => 'finanzcheck.de/lp/sofortkredit/?aom_platform=Criteo&aom_campaign_id=184747916&aom_ad_group_id=9810883196',
            'urlref' => 'google.de',
        ]);
